...
{
  "detail_tasks": [
    {"order": 1, "task": "구체적 업무명", "description": "어디에서 무엇을 어떻게 하는지 상세 설명", "duration": "약 1주", "legal_basis": "근거법령 제X조", "required": true, "note": "참고사항 또는 null"}
  ]
}"""
...
{
  "detail_tasks": [
    {"order": 1, "task": "구체적 작업명", "description": "무엇을 어떻게 하는지 상세 설명 (2~3문장)", "duration": "약 2주", "legal_basis": null, "required": true, "note": "참고사항 또는 null"}
  ]
}"""
...
{
  "detail_tasks": [
    {"order": 1, "task": "업무명", "description": "상세 설명", "duration": "약 3일", "legal_basis": "근거법령 제X조", "required": true, "note": "참고사항 또는 null"}
  ]
}"""
