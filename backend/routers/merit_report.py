...
_DEFAULT_GENERATION_PROMPT = """당신은 충주시의 공무원 공적조서를 작성하는 행정 전문가입니다.
...
async def generate_merit_report(request: MeritReportRequest):
    ...
    _template = prompt_service.get(
        "merit_report", "generation_prompt",
        default=_DEFAULT_GENERATION_PROMPT
    )
    prompt = _template.format(
        ...
        achievement_area=request.achievement_area,
        merit_str=merit_str
    )
