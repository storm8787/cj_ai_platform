...
_DEFAULT_SYSTEM_PROMPT = (
    ...
    "- 서술형 섹션은 너무 짧게 끊지 말고 문장 간 흐름을 유지함\n"
...
- 서술형(추진배경·현황·현황분석·문제점·상황개요 등): 짧게 끊지 말고 **2~3문장의 자연스러운 문장형**으로 서술(배경·원인·맥락을 이어서 설명, 문장 간 흐름 유지). 이 섹션은 항목을 1~2개로 줄이고 각 항목을 문장형으로 채움
